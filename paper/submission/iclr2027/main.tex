...
gradients. In randomized interleaved measurements on an H100 NVL, the complete
fprop+Dgrad+Wgrad+inverse-RHT pipeline is within 0.5--1.7\% of the separate
implementation at square-8192 and the two Llama projections; square-4096 is
4.9\% slower. The fused two-view preprocessing remains 7--14\% slower because
the H16 output is recomputed for independent columnwise scales. We report this
as a separate architecture result rather than combining its absolute latency
with the H100 80GB HBM3 tables.
