...
$11008\rightarrow4096$ down projection. Fused RHT/FP8 is 1.061$\times$ faster
in forward and 1.017$\times$ faster for the full training step than separate
RHT plus TE quantization. It retains 94.4\% and 92.7\% of the corresponding
plain block-FP8 throughput. This is a performance dataflow experiment rather
than a model-equivalence result; paired weight rotations and convergence remain
future work. We report these as separate H100 NVL architecture results rather
than mixing their absolute latency with the H100 80GB HBM3 tables.
