...
most $4.8\times10^{-8}$ and $2.4\times10^{-7}$. For a 4096-token
$4096\rightarrow22016\rightarrow4096$ SwiGLU MLP, fusion reduces the complete
step from 10.460 to 7.436 ms (1.407$\times$) and the optimizer tail from 4.402
to 1.405 ms (3.132$\times$) relative to explicit $R^\top$ mapping plus foreach
...
\section{Limitations}
The primary hybrid MLP has three independent process repetitions, while the
fused-optimizer and remaining timing sweeps still require independent repetitions, confidence
