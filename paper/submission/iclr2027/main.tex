...
Finally, we compare with ordinary Transformer Engine block FP8 using matched
...
substantially reducing dynamic instructions. In the randomized FP8 training
pipeline, RHT still costs 18.8\% in forward and 5.1\% in backward relative to
ordinary TE, but fusing its inverse directly into AdamW removes enough memory
traffic and launches to make the complete controlled step 1.312$\times$ faster.
